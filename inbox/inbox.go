...
func PostToInbox(ctx context.Context, opts *PostToInboxOptions) error {
	...
	logger.Debug("Post to inbox", "inbox", opts.Inbox)
	...
	*/
	...
	logger.Debug("Response", "inbox", opts.Inbox, "code", http_rsp.StatusCode, "content-type", http_rsp.Header.Get("Content-Type"))
